 ...
 */
PUBLIC_SYM chirp_connect_t * ICACHE_FLASH_ATTR
new_chirp_connect(const char *key, const char *secret);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
del_chirp_connect(chirp_connect_t **connect);

/**
 * Free some memory previously allocated and returned by the SDK.
 * @param ptr The pointer to the memory to be freed.
 */
PUBLIC_SYM void ICACHE_FLASH_ATTR
chirp_connect_free(void *ptr);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_set_config(chirp_connect_t *connect, const char *config);
 ...
 */
PUBLIC_SYM char * ICACHE_FLASH_ATTR
chirp_connect_get_info(chirp_connect_t *connect);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_start(chirp_connect_t *connect);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_pause(chirp_connect_t *connect, bool pause);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_stop(chirp_connect_t *connect);
 ...
 */
PUBLIC_SYM uint8_t * ICACHE_FLASH_ATTR
chirp_connect_new_payload(chirp_connect_t *connect, size_t length);
 ...
 *                invalid.
 */
PUBLIC_SYM size_t ICACHE_FLASH_ATTR
chirp_connect_get_max_payload_length(chirp_connect_t *connect);
 ...
 */
PUBLIC_SYM float ICACHE_FLASH_ATTR
chirp_connect_get_duration_for_payload_length(chirp_connect_t *connect, size_t length);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_is_valid(chirp_connect_t *connect, const uint8_t *bytes, size_t length);
 ...
 */
PUBLIC_SYM uint8_t * ICACHE_FLASH_ATTR
chirp_connect_random_payload(chirp_connect_t *connect, size_t *length);
 ...
 */
PUBLIC_SYM char * ICACHE_FLASH_ATTR
chirp_connect_as_string(chirp_connect_t *connect, uint8_t *bytes, size_t length);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_send(chirp_connect_t *connect, uint8_t *bytes, size_t length);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_process(chirp_connect_t *connect, float *in, float *out, size_t length);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_process_input(chirp_connect_t *connect, float *buffer, size_t length);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_process_output(chirp_connect_t *connect, float *buffer, size_t length);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_process_shorts(chirp_connect_t *connect, short *in, short *out, size_t length);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_process_shorts_input(chirp_connect_t *connect, const short *buffer, size_t length);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_process_shorts_output(chirp_connect_t *connect, short *buffer, size_t length);
 ...
 */
PUBLIC_SYM chirp_connect_state_t ICACHE_FLASH_ATTR
chirp_connect_get_state_for_channel(chirp_connect_t *connect, uint8_t channel);
 ...
 */
PUBLIC_SYM uint8_t ICACHE_FLASH_ATTR
chirp_connect_get_transmission_channel(chirp_connect_t *connect);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_set_transmission_channel(chirp_connect_t *connect, uint8_t channel);
 ...
 */
PUBLIC_SYM uint8_t ICACHE_FLASH_ATTR
chirp_connect_get_channel_count(chirp_connect_t *connect);
 ...
 */
PUBLIC_SYM chirp_connect_state_t ICACHE_FLASH_ATTR
chirp_connect_get_state(chirp_connect_t *connect);
 ...
 */
PUBLIC_SYM float ICACHE_FLASH_ATTR
chirp_connect_get_volume(chirp_connect_t *connect);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_set_volume(chirp_connect_t *connect, float volume);
 ...
 */
PUBLIC_SYM uint32_t ICACHE_FLASH_ATTR
chirp_connect_get_input_sample_rate(chirp_connect_t *connect);
 ...
 */
PUBLIC_SYM uint32_t ICACHE_FLASH_ATTR
chirp_connect_get_output_sample_rate(chirp_connect_t *connect);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_set_input_sample_rate(chirp_connect_t *connect, uint32_t sample_rate);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_set_output_sample_rate(chirp_connect_t *connect, uint32_t sample_rate);
 ...
 */
PUBLIC_SYM bool ICACHE_FLASH_ATTR
chirp_connect_get_auto_mute(chirp_connect_t *connect);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_set_auto_mute(chirp_connect_t *connect, bool auto_mute);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_set_callback_ptr(chirp_connect_t *connect, void *ptr);
 ...
 */
PUBLIC_SYM chirp_connect_error_code_t ICACHE_FLASH_ATTR
chirp_connect_set_frequency_correction(chirp_connect_t *connect, float correction);
 ...
 *         representation.
 */
PUBLIC_SYM const char * ICACHE_FLASH_ATTR
chirp_connect_get_version(void);
